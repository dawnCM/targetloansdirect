			...
			<div id="pghd_wrap">
		        <div class="container">
		            <div class="row">
		                <div class="col-sm-12">
		                    <div id="logobox">
		                    <?php echo $this->Html->image('ecapital.png', array('alt'=>'ecapital', 'class'=>'img-responsive', 'style="margin-top:20px;"','width'=>'235', 'height'=>'35', 'url'=>'/')); ?>
		                    </div>
		                  <div id="tagline">
			...
			<div class="container">
		    	<div class="row">
		        	<div class="col-sm-4">
		                ...
		                <strong>It’s Fast<br>
		                </strong>Receive quick personal loans with online approvals. </div>
		            </div>
		        	<div class="col-sm-4">
		            	<div class="sec02_icon">
			...
			<div class="container">
		    	<div class="row">
		        	<div class="col-sm-12">
		                ...
		                <div id="sec04_text">
		                Emergencies come up for rent, bills, car troubles or other needs. We are here to help. Our large database of lenders is designed to match you with one quickly. Simply complete your online profile and you could get immediate cash relief to meet your urgent needs now!
		                </div>
		            </div>
		        </div>
		    </div>
		...
		After you are matched with a lender, the lender is required to provide you, the consumer, with all costs associated to be expressed as an annual percentage rate of interest (APR). This information will include the identity of the creditor, the amount financed, the itemization of amount financed, the finance charge, the annual percentage rate, your payment schedule and your total number of payments. You will be able to review all this information BEFORE you obligate yourself to any loan. Your interest rate will vary depending upon which product you select from which lender. In addition, the Federal Equal Credit Opportunity Act prohibits creditors from discriminating against applicants on the basis of color, race, religion, sex, marital status and age.                      </div>
		        ...
		        <div class="row">
		        	<div class="col-sm-12" id="footer_auth">
 						<b>For your protection:</b> Our lender partners will never call and ask for advance payment. NEVER pay a lender in advance for a loan. The operator of this website is not an agent, representative or broker of any lender and does not endorse or charge you for any service or product. We are NOT your lender or provider of your end product and we do NOT make any credit decisions. We can’t guarantee loan approval or advertised loan amount. Amounts will vary by state and by lender.
