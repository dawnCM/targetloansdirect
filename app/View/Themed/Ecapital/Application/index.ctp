                    ...
                    <div class="row">
                    	<span class="additional_lenders" style="display:none";>
	                    	...
	                    	<div class="col-sm-4">
                   			...
                   			<div class="col-sm-4" style = "cursor:pointer"><?php echo $this->Html->image('no_bank_acct.png', array('alt'=>'No Bank Account', 'class'=>'img-responsive', 'width'=>'130', 'height'=>'30', 'id'=>'no_bank')); ?></div>
                       </span>
                       <span class="additional_lenders">
                      	<div class="col-sm-4"></div>
                      	<div class="col-sm-4 text-center" style="cursor:pointer"><?php echo $this->Html->image('no_bank_acct.png', array('alt'=>'No Bank Account', 'class'=>'', 'width'=>'130', 'height'=>'30', 'id'=>'no_bank_pd')); ?></div>
                    	<div class="col-sm-4"></div>
                    </div>             
