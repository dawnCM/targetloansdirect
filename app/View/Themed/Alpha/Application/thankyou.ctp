                  ...
                  <div class="tab-pane tab5" id="tab5" style="display:initial;">
                      <div class="row">
                          <div class="col-sm-12">
                              ...
                              <strong>Thank you:</strong> <span style="font-size: 14px">We have matched you with our <strong><em>Elite Lenders</em></strong></span>
                              </div>
                          </div>
                      </div>
                      <div class="row">
                      <div class="col-sm-4 text-center">
                      <?php echo $this->Html->link($this->Html->image('netctredit-banner.png', array('alt'=>'NetCredit', 'width'=>'340', 'height'=>'270', 'class'=>'img-responsive')), 'http://leadstudiotrack.com/?a=131&c=295&p=r&s1=CommErr', array('target'=>'_blank','escape'=>false)); ?>
                      ...
                      <div class="col-sm-4 text-center">
                      <?php echo $this->Html->link($this->Html->image('prosper-banner.png', array('alt'=>'Prosper', 'width'=>'340', 'height'=>'270', 'class'=>'img-responsive')), 'http://leadstudiotrack.com/?a=131&c=236&p=r&s1=CommErr', array('target'=>'_blank','escape'=>false)); ?>
                      </div>
                    </div>
