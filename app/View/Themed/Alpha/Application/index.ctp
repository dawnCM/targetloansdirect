    ...
    if($this->Session->read('Application.AppType') == 'payday'){?>
      ...
      <div class="row">
          <div class="col-sm-12">
                ...
                <?php 
                if(strpos($myapptype,'payday') !== false){
                        ...
                        <div class="col-md-4">
                          <div class="col-md-1" ></div>
                            <div class="form-group col-md-12">
                              <select class="form-control" id='LoanAmount' name='LoanAmount' data-parsley-required="true" data-parsley-group="step7">
                                  <option value="">Choose Amount</option>
                                  <?php 
